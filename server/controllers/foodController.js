...
// import FoodItem from '../models/foodModel.js'; // Make sure to import FoodItem instead of Food
// import { handleImageUpload } from '../utils/cloudinary.js';

// // Get all food items
// export const getFoodItems = async (req, res) => {
//   try {
//     const foodItems = await FoodItem.find().populate('restaurant'); // Use FoodItem
...
//   try {
//     const foodItem = await FoodItem.findById(req.params.id).populate('restaurant'); // Use FoodItem
...
//   try {
//     let imageUrl;
//     const { name, price, description, restaurant, availability } = req.body; // Removed category since it's not in your model
...
//     const foodItem = new FoodItem({ // Use FoodItem
//       name,
//       price,
//       description,
//       image: imageUrl,
