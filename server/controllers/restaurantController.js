...
//     const { name, location, rating, foodItems, image } = req.body;
...
//     } else if (image) {
//       imageUrl = image; // Use the provided URL
//     }
...
//     const restaurant = await Restaurant.findById(restaurantId).populate('foodItems'); // Populate foodItems
//     if (!restaurant) {
